...
function Iterated(config) {
  ...
  // APP
  var app = new PIXI.Application(700, 250, {
    transparent: true,
    resolution: 2,
  });
  self.app = app;
  ...
  // LABELS
  var _l1 = _makeLabel("label_they_cooperate", {
    x: 354,
    y: 34,
    rotation: 45,
    align: "center",
  ...
  var _l2 = _makeLabel("label_you_cooperate", {
    x: 272,
    y: 35,
    rotation: -45,
    align: "center",
  ...
  var _l3 = _makeLabel("label_they_cheat", {
    x: 406,
    y: 86,
    rotation: 45,
    align: "center",
  ...
  var _l4 = _makeLabel("label_you_cheat", {
    x: 224,
    y: 83,
    rotation: -45,
    align: "center",
  ...
  // Machine
  self.machine = _makeMovieClip("iterated_machine", {
    anchorX: 0,
    anchorY: 0,
    scale: 0.5,
  });
  ...
  self.chooseOpponent = function (id) {
    ...
    self.playerB.chooseHat("anonymous");
  };
...
function IteratedPeep(config) {
  ...
  // Body
  self.body = _makeMovieClip("iterated_peep", {
    scale: 0.5,
    anchorX: 0.5,
    anchorY: 0.95,
  });
  ...
  // Hat
  self.hat = _makeMovieClip("iterated_peep", {
    scale: 0.5,
    anchorX: 0.5,
    anchorY: 0.95,
  });
  ...
  self.chooseHat = function (id) {
    console.log("id: " + PEEP_METADATA[id].frame);
    if (PEEP_METADATA[id].frame < 6) {
      self.hat.gotoAndStop(13 + PEEP_METADATA[id].frame);
    } else {
      self.hat.gotoAndStop(23);
    }
  };

  // Face
  self.face = _makeMovieClip("iterated_peep", {
    scale: 0.5,
    anchorX: 0.5,
    anchorY: 0.95,
  });
  ...
  // Eyebrows
  self.eyebrows = _makeMovieClip("iterated_peep", {
    scale: 0.5,
    anchorX: 0.5,
    anchorY: 0.95,
  });
  ...
  self.update = function (delta) {
    ...
    if (self.restingFace) {
      ...
      if (self.face.currentFrame == 2 && Math.random() < 0.2)
        self.face.gotoAndStop(1);
      if (self.face.currentFrame == 1 && Math.random() < 0.01)
        self.face.gotoAndStop(2);
    }
  ...
  var _animate2_alt = function () {
    ...
    Tween_get(self.animated)
      ...
      .call(function () {
        ...
        Tween_get(g.scale).to({ x: 1, y: 1 }, _s(0.5), Ease.elasticOut);
      })
      .wait(_s(0.1))
      .call(_animate3_alt);
  };
  ...
  var _animate3_alt = function () {
    Tween_get(self.animated).wait(_s(0.9)).call(_animate4_alt);
  };

  // Walk back
  var _animate4 = function () {
    _isHopping = true;
    Tween_get(self.animated).to({ x: 0 }, _s(0.5), Ease.linear).call(_animate5);
  };
  ...
  var _animate5 = function () {
    ...
    if (self.payoff == PD.PAYOFFS.R || self.payoff == PD.PAYOFFS.T) {
      ...
      Tween_get(self.animated).wait(_s(0.8)).call(_animateDone);
    } else {
      Tween_get(self.animated).wait(_s(0.3)).call(_animateDone);
    }
  };
